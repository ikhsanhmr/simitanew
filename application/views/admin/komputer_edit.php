                ...
                <div class="box box-success">
                    <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/action_komputer_edit?id_komputer=<?php echo $komputernya['id_komputer']; ?>" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <?php     } else { ?>
                                <div class="col-sm-6" id="toggleText" style="display: block;">
                                    <div class="form-group">
                                        <label for="id_vendor" class="col-sm-3 control-label">Vendor</label>
                                        <div class="col-sm-9">
                                            <select class="form-control select2" name="id_vendor" id="id_vendor" style="width: 100%;">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="sistem_operasi" name="sistem_operasi" required placeholder="Masukan Sistem Operasi..." value="<?php echo $komputernya['sistem_operasi']; ?>" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="office" name="office" required placeholder="Masukan jenis office..." value="<?php echo $komputernya['office']; ?>" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control select2" name="status_jd" id="status_jd" style="width: 100%;">
                                            <option selected="selected" value="<?php echo $komputernya['office']; ?>"> <?= $komputernya['office'] ? "Ya" : "Tidak" ?> </option>
                                            <option value=""> -- Pilih Status JD -- </option>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="kes" name="kes" required placeholder="Masukan jenis antivirus..." value="<?= $komputernya['kes']; ?>" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="mouse" name="mouse" required placeholder="Masukan nama mouse..." value="<?= $komputernya['mouse']; ?>" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="keyboard" name="keyboard" required placeholder="Masukan nama keyboard..." value="<?= $komputernya['keyboard']; ?>" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="monitor" name="monitor" required placeholder="Masukan nama monitor..." value="<?= $komputernya['monitor']; ?>" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" class="form-control" id="tgl_kontrak" name="tgl_kontrak" required value="<?= $komputernya['tgl_kontrak']; ?>" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" step="1000" min="1000" class="form-control" id="harga_sewa" name="harga_sewa" required value="<?= $komputernya['harga_sewa']; ?>" />
                                    </div>
                                </div>
                            </div>
