						...
						<div class="box-body">
							...
							<div class="col-lg-10">
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="nama_pic" name="nama_pic" value="<?= $lgangguannya['nama_pic']; ?>" required />
									</div>
								</div>
							</div>
							...
							<div class="col-lg-10">
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="number" class="form-control" id="no_hp_pic" name="no_hp_pic" value="<?= $lgangguannya['no_hp_pic']; ?>" required />
									</div>
								</div>
							</div>
