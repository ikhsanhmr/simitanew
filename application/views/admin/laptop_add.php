 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Admin
        <small>Add Laptop</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Admin</a></li>
        <li class="active">Add Laptop</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-success">
		   <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/action_laptop_add" enctype="multipart/form-data">
...
Hardisk :	
						...
						<div class="col-lg-10">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
								 <input type="text" class="form-control" id="nama_pengguna" name="nama_pengguna" placeholder="Input Nama Pengguna.." />
                                </div>
                            </div>
                        </div>
						<br><br><br>
