...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Admin
            <small>Edit Kategori Gangguan</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Admin</a></li>
            <li class="active">Edit Kategori Gangguan</li>
        </ol>
    </section>
              ...
              <div class="box box-success">
                <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/action_kategori_gangguan_edit?data_id=<?php echo $kategori_gangguannya['id_kategori']; ?>" enctype="multipart/form-data">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">Edit Kategori Gangguan</h3>
                    </div>
                    <div class="box-body">
                        <div class="col-lg-10">
                            <div class="form-group">
                                <label for="kategori" class="col-sm-3 control-label">Kategori Gangguan</label>
                                <div class="col-sm-5">
