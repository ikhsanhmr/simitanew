    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-success">
          <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/action_kesiapan_pop_scada_up2d_add" enctype="multipart/form-data">
            ...
            <div class="box-body">
              <div class="col-lg-10">
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="nama_link" name="nama_link" required />
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <select class="mb-2 form-control select2 pop" name="pop" style="width: 100%;">
                      <option selected="selected" value=""> -- Pilih POP -- </option>
            ...
            <div class="box-body">
              <div class="col-lg-10">
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="number" class="form-control" id="beban_pop" name="beban_pop" required />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="box-body">
              <div class="col-lg-10">
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="number" class="form-control" id="kapasitas_baterai" name="kapasitas_baterai" required />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="box-body">
              <div class="col-lg-10">
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="number" class="form-control" id="ketahanan_baterai" name="ketahanan_baterai" required />
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <select class="mb-2 form-control select2 genset" name="genset" style="width: 100%;">
                      <option selected="selected" value=""> -- Pilih Status Genset -- </option>
