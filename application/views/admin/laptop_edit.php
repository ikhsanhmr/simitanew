 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Admin
        <small>Edit Laptop</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Admin</a></li>
        <li class="active">Edit Laptop</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-success">
		   <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>admin/action_laptop_edit?id_laptop=<?php echo $laptopnya['id_laptop']; ?>" enctype="multipart/form-data">
				
				 <input type="hidden" name="id_laptop" value="<?php echo $laptopnya['id_laptop']; ?>">
            ...
            <div class="box-body">
						<div class="col-lg-10">
                            <div class="form-group">
                                <label for="id_merek" class="col-sm-3 control-label">Merk Laptop</label>
                                <div class="col-sm-5">
								  <select class="form-control select2" id="id_merek" name="id_merek" style="width: 100%;"/>	
									<option value="<?php echo $laptopnya['id_merek']; ?>" selected="selected"><?php echo $laptopnya['nama_mereknya']; ?></option>
										<option> -- Pilih Merek Lain -- </option>
													<?php foreach ($list_merek_laptop->result_array() as $data) { ?>
            ...
            <div class="col-lg-10">
						...
						<div class="col-lg-10">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
								 <input type="text" class="form-control" id="spesifikasi" name="spesifikasi" value="<?php echo $laptopnya['spesifikasi']; ?>" required/>
                                </div>
                            </div>
                        </div>
						<br><br><br>
						<div class="col-lg-10">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
								 <input type="text" class="form-control" id="nama_pengguna" name="nama_pengguna" value="<?php echo $laptopnya['nama_pengguna']; ?>" required/>
                                </div>
                            </div>
                        </div>
						<br><br><br>
						...
						<?php foreach($unitnya->result_array() as $unitnya){
                            if($laptopnya['id_unit'] == $unitnya['id_unit_level3']) {?>
                        <div class="col-lg-10">
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
								  <select class="form-control select2" id="status_kepemilikan" name="status_kepemilikan" style="width: 100%;" onchange="statusnya()"/>	
									<option value="<?php echo $laptopnya['status_kepemilikan']; ?>" selected="selected"><?php echo $laptopnya['status_kepemilikan']; ?></option>
						...
						<?php 
						if ($laptopnya['status_kepemilikan']=='Aset PLN'){ ?>
					...
					<?php 	} else { ?>
						<div class="col-lg-10" id="toggleText" style="display: block;">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
								 <select class="form-control select2" name="id_vendor" id="id_vendor" style="width: 100%;">
									<option value="<?php echo $laptopnya['id_vendor']; ?>" selected="selected"><?php echo $laptopnya['nama_vendornya']; ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
								  <select class="form-control select2" id="tahun" name="tahun" style="width: 100%;"/>	
									<option value="<?php echo $laptopnya['tahun']; ?>" selected="selected"><?php echo $laptopnya['tahun']; ?></option>
			...
			<div class="box-footer">
                        <div class="pull-center">
                            ...
                            <a href="<?php echo base_url(); ?>admin/laptop_view" class="btn btn-danger">Kembali</a>
