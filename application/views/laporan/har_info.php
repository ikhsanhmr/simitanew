                                                 ...
                                                 <tbody>
                                                     ...
                                                     <tr>
                                                         <td class="text-center">
                                                             ...
                                                             <?php } else if ($data['tampak_fisik'] == 'Ada error') { ?>
                                                         ...
                                                         <td class="text-center">
                                                             <?php
                                                                if ($data['indikator_lampu'] == 'Normal') { ?>
                                                                 <a class="btn btn-success">Normal </a>
                                                             <?php } else if ($data['indikator_lampu'] == 'Ada error') { ?>
                                                                 <a class="btn btn-warning">Ada Error </a>
                                                             <?php } else { ?>
                                                                 <a class="btn btn-danger">Rusak</a>
                                                             <?php }
                                                         ...
                                                         <td class="text-center">
                                                             <?php
                                                                if ($data['power_supply'] == 'Normal') { ?>
                                                                 <a class="btn btn-success">Normal </a>
                                                             <?php } else if ($data['power_supply'] == 'Ada error') { ?>
                                                                 <a class="btn btn-warning">Ada Error </a>
                                                             <?php } else { ?>
                                                                 <a class="btn btn-danger">Rusak</a>
                                                             <?php }
                                                         ...
                                                         <td class="text-center">
                                                             <?php
                                                                if ($data['lan'] == 'Normal') { ?>
                                                                 <a class="btn btn-success">Normal </a>
                                                             <?php } else if ($data['lan'] == 'Ada error') { ?>
                                                                 <a class="btn btn-warning">Ada Error </a>
                                                             <?php } else { ?>
                                                                 <a class="btn btn-danger">Rusak</a>
                                                             <?php }
                                                         ...
                                                         <td class="text-center">
                                                             <?php
                                                                if ($data['port'] == 'Normal') { ?>
                                                                 <a class="btn btn-success">Normal </a>
                                                             <?php } else if ($data['port'] == 'Ada error') { ?>
                                                                 <a class="btn btn-warning">Ada Error </a>
                                                             <?php } else { ?>
                                                                 <a class="btn btn-danger">Rusak</a>
                                                             <?php }
                                                         ...
                                                         <td class="text-center">
                                                             <?php
                                                                if ($data['konfigurasi'] == 'Normal') { ?>
                                                                 <a class="btn btn-success">Normal </a>
                                                             <?php } else if ($data['konfigurasi'] == 'Ada error') { ?>
                                                                 <a class="btn btn-warning">Ada Error </a>
                                                             <?php } else { ?>
                                                                 <a class="btn btn-danger">Rusak</a>
                                                             <?php }
                                                         ...
                                                         <td class="text-center">
                                                             <?php
                                                                if ($data['backup_setting'] == 'Normal') { ?>
                                                                 <a class="btn btn-success">Normal </a>
                                                             <?php } else if ($data['backup_setting'] == 'Ada error') { ?>
                                                                 <a class="btn btn-warning">Ada Error </a>
                                                             <?php } else { ?>
                                                                 <a class="btn btn-danger">Rusak</a>
                                                             <?php }
